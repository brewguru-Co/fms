            ...
            <Form>
              <Box className={classes.box} margin={1}>
                <TextField
                  ...
                  helperText={touched.name && errors.name ? errors.name || TEA.DUPLICATED : ''}
                />
                <TextField
                  required
                  margin='dense'
                  ...
                  helperText={touched.phLowOp && errors.phLowOp ? errors.phLowOp : ''}
                />
                <TextField
                  required
                  margin='dense'
                  ...
                  helperText={touched.phHighOp && errors.phHighOp ? errors.phHighOp : ''}
                />
                <TextField
                  required
                  margin='dense'
                  ...
                  helperText={touched.tempLowOp && errors.tempLowOp ? errors.tempLowOp : ''}
                />
                <TextField
                  required
                  margin='dense'
                  ...
                  helperText={touched.tempHighOp && errors.tempHighOp ? errors.tempHighOp : ''}
                />
                <TextField
                  required
                  margin='dense'
                  ...
                  helperText={touched.doxLowOp && errors.doxLowOp ? errors.doxLowOp : ''}
                />
                <TextField
                  required
                  margin='dense'
                  ...
                  helperText={touched.doxHighOp && errors.doxHighOp ? errors.doxHighOp : ''}
                />
                <TextField
                  required
                  margin='dense'
                  ...
                  helperText={touched.brixLowOp && errors.brixLowOp ? errors.brixLowOp : ''}
                />
                <TextField
                  required
                  margin='dense'
                  ...
                  helperText={touched.brixHighOp && errors.brixHighOp ? errors.brixHighOp : ''}
                />
              </Box>
              <Box className={classes.box} margin={1}>
